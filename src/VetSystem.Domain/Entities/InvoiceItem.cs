...
/// <see cref="PrescriptionId"/> / <see cref="ProcedureId"/> back-links record that this line bills a
/// specific <c>dispensed_to_owner</c> prescription or a visit procedure, so the issuance assembler
