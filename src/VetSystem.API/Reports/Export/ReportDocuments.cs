...
public static class ReportDocuments
{
    ...
    public static ReportDocument ProfitPerBatch(ProfitPerBatchReportResponse r) => new(
        ...
        Summary: Fields(
            ...
            MoneyField(ReportLabels.SupervisionFee, r.ExamFee),
            MoneyField(ReportLabels.DoctorShare, r.DoctorShare),
            r.FeeAddedToSettlement != 0m ? MoneyField(ReportLabels.FeeAddedToSettlement, r.FeeAddedToSettlement) : null,
            r.FeeRetainedByClinic != 0m ? MoneyField(ReportLabels.FeeRetainedByClinic, r.FeeRetainedByClinic) : null,
            r.SettlementDiscount != 0m ? MoneyField(ReportLabels.SettlementDiscount, r.SettlementDiscount) : null,
